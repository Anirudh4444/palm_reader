...
const LINE_FACTS = [
  { key: 'lifeLine', icon: 'heart-pulse', color: '#E85555', description: 'Reveals vitality, energy, and major life changes' },
  { key: 'heartLine', icon: 'heart', color: '#E87070', description: 'Shows emotional nature, relationships, and love' },
  { key: 'headLine', icon: 'brain', color: '#9B5FE8', description: 'Indicates intellect, communication, and wisdom' },
  { key: 'fateLine', icon: 'star-four-points', color: '#E8B840', description: 'Reveals career, destiny, and life path' },
  { key: 'sunLine', icon: 'white-balance-sunny', color: '#E8D040', description: 'Fame, success, and artistic talents' },
];
    ...
    <LinearGradient colors={['#0A0415', '#12082A']} style={styles.container}>
      ...
      >
        ...
        <Animated.View entering={FadeInDown.delay(400)} style={styles.section}>
          <Text style={styles.sectionTitle}>Palm Lines Guide</Text>
        ...
        <Animated.View entering={FadeInDown.delay(500)} style={styles.section}>
          ...
          <View style={styles.mythCard}>
            <LinearGradient colors={['#1A0D35', '#251350']} style={styles.mythCardInner}>
              ...
              <Text style={styles.mythTitle}>Hasta Samudrikam</Text>
              <Text style={styles.mythText}>
                Ancient Indian palmistry, known as Hasta Samudrikam, is rooted in Vedic tradition. The hand is seen as a microcosm of the universe, with each line and mount corresponding to planetary influences and divine energy.
              </Text>
            </LinearGradient>
          </View>
        </Animated.View>
